...
class PsicossocialDocumentoController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('can:consultar documentos psicossociais'),
        ];
    }

    public function index(Request $request)
    {
        return view('secretaria-escolar.psicossocial.documentos.index', [
    ...
    {
        return view('secretaria-escolar.psicossocial.documentos.preview', [
