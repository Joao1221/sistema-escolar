...
class UpdateHorarioDirecaoRequest extends FormRequest
{
    public function authorize(): bool
    {
        $usuario = $this->user();

        return ($usuario?->can('editar horarios da direcao') ?? false)
            || ($usuario?->can('reorganizar horarios da direcao') ?? false);
    }
