<x-secretaria-layout>
    <div class="space-y-6 px-8 py-6">
        <div>
            <p class="text-sm font-semibold uppercase tracking-[0.3em] text-indigo-600">Auditoria da Rede</p>
        ...
        @include('auditoria.partials.filtros', ['rotaIndex' => route('secretaria.auditoria.index')])
