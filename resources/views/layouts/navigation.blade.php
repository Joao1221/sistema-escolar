<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('instituicao.show')" :active="request()->routeIs('instituicao.*')">
                        {{ __('Instituição') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('escolas.index')" :active="request()->routeIs('escolas.*')">
                        {{ __('Escolas') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @hasanyrole('Administrador da Rede')
            <x-responsive-nav-link :href="route('instituicao.show')" :active="request()->routeIs('instituicao.*')">
                {{ __('Instituição') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('escolas.index')" :active="request()->routeIs('escolas.*')">
                {{ __('Escolas') }}
            </x-responsive-nav-link>
