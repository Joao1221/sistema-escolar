<x-secretaria-escolar-layout>
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-2xl border border-gray-100">
        <form method="POST" action="{{ route('secretaria-escolar.alunos.update', $aluno) }}" x-data="{ tab: 'pessoal' }">
            @csrf
            @method('PUT')
            ...
            <div class="p-6">
                ...
                {{-- Conteúdo: Filiação --}}
                <div x-show="tab === 'filiacao'" x-transition class="space-y-6" style="display: none;">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                ...
                <div x-show="tab === 'endereco'" x-transition class="space-y-6" style="display: none;">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <x-text-input id="logradouro" name="logradouro" type="text" class="mt-1 block w-full uppercase" :value="old('logradouro', $aluno->logradouro)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="complemento" name="complemento" type="text" class="mt-1 block w-full uppercase" :value="old('complemento', $aluno->complemento)" />
                            <x-input-error :messages="$errors->get('complemento')" class="mt-2" />
                        </div>
                        <div>
                            <x-input-label for="bairro" :value="__('Bairro')" />
                            <x-text-input id="bairro" name="bairro" type="text" class="mt-1 block w-full uppercase" :value="old('bairro', $aluno->bairro)" required />
                            <x-input-error :messages="$errors->get('bairro')" class="mt-2" />
                        </div>
                        <div class="md:col-span-2">
                            <x-input-label for="cidade" :value="__('Cidade')" />
                            <x-text-input id="cidade" name="cidade" type="text" class="mt-1 block w-full uppercase" :value="old('cidade', $aluno->cidade)" required />
                ...
                <div x-show="tab === 'saude'" x-transition class="space-y-6" style="display: none;">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <textarea id="alergias" name="alergias" rows="3" class="mt-1 block w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm">{{ old('alergias', $aluno->alergias) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="medicamentos" name="medicamentos" rows="3" class="mt-1 block w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm">{{ old('medicamentos', $aluno->medicamentos) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="restricoes_alimentares" name="restricoes_alimentares" rows="3" class="mt-1 block w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm">{{ old('restricoes_alimentares', $aluno->restricoes_alimentares) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="obs_saude" name="obs_saude" rows="3" class="mt-1 block w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm">{{ old('obs_saude', $aluno->obs_saude) }}</textarea>
