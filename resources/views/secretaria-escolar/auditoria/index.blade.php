<x-secretaria-escolar-layout>
    <div class="space-y-6 px-8 py-6">
        <div>
            <p class="text-sm font-semibold uppercase tracking-[0.3em] text-emerald-600">Auditoria Escolar</p>
        ...
        @include('auditoria.partials.filtros', ['rotaIndex' => route('secretaria-escolar.auditoria.index')])
