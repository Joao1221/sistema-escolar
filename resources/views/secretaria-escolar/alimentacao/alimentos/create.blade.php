    ...
    <div class="px-8 py-6">
        <div class="mx-auto max-w-3xl rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-slate-900">Novo alimento</h1>
                    <p class="mt-2 text-sm text-slate-500">Cadastre um item para uso em estoque, movimentacoes e cardapio.</p>
                </div>
            ...
            <form method="POST" action="{{ route('secretaria-escolar.alimentacao.alimentos.store') }}" class="mt-8 grid gap-5">
                @csrf
                <div>
