<nav class="w-64 bg-slate-900 text-white min-h-screen flex flex-col flex-shrink-0 shadow-xl" style="background-color: #0f172a;">
    {{-- Logo / Branding --}}
    <div class="p-6">
        ...
        <p class="text-xs text-indigo-300 mt-2 uppercase font-semibold">Secretaria de Educação</p>
    </div>
    ...
    <div class="flex-grow mt-2 overflow-y-auto">
        <div class="px-4 space-y-1">
            ...
            {{-- Visão Geral --}}
            <p class="text-[10px] text-indigo-400 font-bold uppercase tracking-widest pl-2 mb-2">Visão Geral</p>

            <a href="{{ route('secretaria.dashboard') }}"
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('secretaria.dashboard') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-800/60 hover:text-white' }}">
            ...
            <a href="{{ route('hub') }}" 
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-white transition group">
            ...
            <a href="{{ route('secretaria.escolas.index') }}"
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('secretaria.escolas.*') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-800/60 hover:text-white' }}">
                <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
            ...
            <a href="{{ route('secretaria.funcionarios.index') }}"
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('secretaria.funcionarios.*') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-800/60 hover:text-white' }}">
                <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('secretaria.usuarios.index') }}"
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('secretaria.usuarios.*') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-800/60 hover:text-white' }}">
                <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('secretaria.alunos.index') }}"
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('secretaria.alunos.*') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-800/60 hover:text-white' }}">
                <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
            ...
            <a href="{{ route('secretaria.matriculas.index') }}"
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('secretaria.matriculas.*') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-800/60 hover:text-white' }}">
                <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('secretaria.turmas.index') }}"
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('secretaria.turmas.*') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-800/60 hover:text-white' }}">
                <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('secretaria.disciplinas.index') }}"
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('secretaria.disciplinas.*') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-800/60 hover:text-white' }}">
                <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
            ...
            <a href="{{ route('secretaria.matrizes.index') }}"
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('secretaria.matrizes.*') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-800/60 hover:text-white' }}">
                <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('secretaria.instituicao.show') }}"
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('secretaria.instituicao.*') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-800/60 hover:text-white' }}">
                <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('secretaria.configuracoes.index') }}"
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('secretaria.configuracoes.*') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-800/60 hover:text-white' }}">
                <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('secretaria.documentos.index') }}"
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('secretaria.documentos.*') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-800/60 hover:text-white' }}">
                <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('secretaria.relatorios.index') }}"
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('secretaria.relatorios.*') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-800/60 hover:text-white' }}">
                <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('secretaria.auditoria.index') }}"
               class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition {{ request()->routeIs('secretaria.auditoria.*') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-800/60 hover:text-white' }}">
                <svg class="w-5 h-5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
