<aside class="relative overflow-hidden bg-[#163229] text-white lg:w-[290px]">
    ...
    <div class="relative flex h-full flex-col">
        ...
        <div class="border-t border-white/10 px-6 py-5">
            <div class="rounded-2xl bg-white/8 p-4">
                ...
                <p class="mt-2 text-sm text-emerald-100/80">A Secretaria Escolar continua registrando o dia a dia da alimentacao em cada unidade.</p>
            </div>
        </div>
    </div>
</aside>
