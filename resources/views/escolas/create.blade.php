<x-secretaria-layout>
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Cadastrar Unidade Escolar</h1>
            <p class="text-sm text-gray-500 mt-1">Preencha os dados da nova escola</p>
        </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-2xl border border-gray-100">
        <div class="p-6">
            <form action="{{ route('secretaria.escolas.store') }}" method="POST" class="space-y-8">
                @csrf
                ...
                <div class="border-b border-gray-100 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="inep" name="inep" type="text" class="mt-1 block w-full" :value="old('inep')" required maxlength="8" inputmode="numeric" pattern="[0-9]{8}" placeholder="28014294" />
                            <x-input-error class="mt-2" :messages="$errors->get('inep')" />
                        </div>
                        <div>
                            <x-input-label for="cnpj" :value="__('CNPJ (opcional)')" />
                            <x-text-input id="cnpj" name="cnpj" type="text" class="mt-1 block w-full" :value="old('cnpj')" placeholder="00.000.000/0000-00" />
                ...
                <div class="border-b border-gray-100 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <x-text-input id="cep" name="cep" type="text" class="mt-1 block w-full" :value="old('cep')" />
                        ...
                        <div>
                            ...
                            <x-text-input id="uf" name="uf" type="text" class="mt-1 block w-full" :value="old('uf')" maxlength="2" />
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input id="nome_gestor" name="nome_gestor" type="text" class="mt-1 block w-full" :value="old('nome_gestor')" />
                            <x-input-error class="mt-2" :messages="$errors->get('nome_gestor')" />
                        </div>
                        <div>
                            <x-input-label for="cpf_gestor" :value="__('CPF do Gestor(a)')" />
                            <x-text-input id="cpf_gestor" name="cpf_gestor" type="text" class="mt-1 block w-full" :value="old('cpf_gestor')" />
                ...
                <div class="flex items-center justify-end border-t pt-6">
                    <x-primary-button>{{ __('Salvar Escola') }}</x-primary-button>
                </div>
            </form>
        </div>
    </div>
