<x-nutricionista-layout :titulo="$tituloPagina" :subtitulo="$subtituloPagina" :breadcrumbs="$breadcrumbs">
    <div class="space-y-6 print:bg-white print:text-black">
        ...
        <div class="no-print flex flex-col gap-4 rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-sm md:flex-row md:items-center md:justify-between">
            <div>
        ...
        <div class="print-break-avoid rounded-3xl border border-slate-200 bg-white/90 shadow-sm print:rounded-none print:border-0 print:bg-white print:shadow-none">
            <div class="border-b border-slate-100 px-6 py-5">
                <h3 class="text-lg font-bold text-[#17332a] font-fraunces">Itens do cardapio</h3>
            </div>
            <div class="divide-y divide-slate-100">
                @foreach ($cardapio->itens as $item)
                    <div class="print-break-avoid px-6 py-4">
